        ...
        {filteredProducts.map(product => (
          <Grid item key={product.id} xs={12} sm={6} md={4}>
            <Card style={cardStyle}>
              ...
              />
              <CardContent>
                <Typography gutterBottom variant="h5" component="h2" style={{ fontFamily: "'Roboto Condensed', sans-serif", fontWeight: 400 }}>
                  {product.title}
                </Typography>
              ...
              <CardActions>
                <Button size="small" color="primary" onClick={() => goToProductDetails(product.id)}>
                  View
                </Button>
